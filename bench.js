...
const levenshteinLte1 = require('./');

const talismanLimited = (a, b) => talisman.limited(1, a, b);
...
//   bench('levenshtein-lte1', function() {
//     paragraphBench(levenshteinLte1);
//   });

//   bench('node-levenshtein', function() {
//     paragraphBench(nodeLevenshtein);
//   });
...
//   bench('talisman-limited', function() {
//     paragraphBench(talismanLimited);
//   });
...
//   bench('levenshtein-lte1', function() {
//     sentenceBench(levenshteinLte1);
//   });

//   bench('node-levenshtein', function() {
//     sentenceBench(nodeLevenshtein);
//   });
...
suite('2000 words, length max=20 min=3 avr=9.5', function() {
  ...
  bench('levenshtein-lte1', function() {
    wordBench(levenshteinLte1);
  });

  bench('talisman-limited', function() {
    wordBench(talismanLimited);
  });

  bench('node-levenshtein', function() {
    wordBench(nodeLevenshtein);
  });
